...
const Home = () => {
  ...
  return (
    <div className=' h-[100vh] bg-[#AAA08D] z-50 pt-20  scroll-smooth home text-black flex flex-col justify-center items-center cursor-cell max-md:text-center max-md:w-full '>


      <h1>Hi, i'm<span   className='font-bold text-[50px] px-2'>Abiodun Quadri Fadipe</span></h1>
      

      <div className="flex gap-4 items-center max-md:w-[390px] max-md:justify-center ">
