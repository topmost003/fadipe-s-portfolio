...
const Contact = () => {
  return (
    <div  className='px-[170px]  h-[100vh] py-30  bg-[#F8F8F8]  max-md:text-center max-md:px-1  max-md:h-[130vh]'>
      <h1 className='font-bold text-6xl text-center max-md:pb-[100px]'>Contact</h1>
